...
public class ActiveProviderChestBlock  extends BlockWithEntity {
    public ActiveProviderChestBlock(Settings settings) {
        super(settings);
    }

    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new ActiveProviderChestBlockEntity(pos, state);
    }
